...
namespace CarritoCompras
{
    public partial class Lista_Comprado : System.Web.UI.Page
    {
        ...
        protected void SendEmail(object sender, EventArgs e)
        {
            ...
            correo.From = new System.Net.Mail.MailAddress("Productosonline@gmail.com");
            ...
            smtp.Port = 587;
            smtp.Credentials = new System.Net.NetworkCredential("Productosonline@gmail.com", "Productosonline@");
            smtp.EnableSsl = true;
            try
            {
                smtp.Send(correo);
